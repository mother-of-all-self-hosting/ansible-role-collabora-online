...
See its [environment variables](https://sdk.collaboraonline.com/docs/installation/CODE_Docker_image.html#setting-the-application-configuration-dynamically-via-environment-variables) for a complete list of CODE's config options that you can put in `collabora_online_environment_variables_additional_variables`.
